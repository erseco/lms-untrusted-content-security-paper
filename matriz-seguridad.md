...
| **H5P.Video · URL EchoVideo** | **Candidato: sí** | Sí en el tipo `iframe` confirmado | iframe H5P sin `sandbox` | Código + microprueba Chromium; *end-to-end* y divulgación pendientes |
...
| H5P.Video · EchoVideo | Candidato: sí | Sí (`iframe`) | autor ordinario si la librería vulnerable está instalada | cualquiera | esperado: sí | No | esperado según rol visitante | código + microprueba Chromium | DOM XSS *same-origin*; *end-to-end* pendiente |
