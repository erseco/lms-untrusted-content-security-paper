...
| H5P · librería (`preloadedJs`) | Sí (código de confianza) | Sí | Ninguno (se ejecuta *same-origin* sin sandbox) | Bajo en contenido; alto si se pueden instalar librerías (`h5p:updatelibraries`, gestión/administración) |
