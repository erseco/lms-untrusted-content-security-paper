...
| `mod_h5pactivity` / `core_h5p` | Parámetros: No (filtra). Librerías: Sí (`preloadedJs`, código de confianza) | Sí | Parámetros filtrados por semántica; el JS de las librerías se ejecuta *same-origin* sin sandbox | Bajo en contenido; alto si se pueden instalar librerías (`h5p:updatelibraries`, gestión/administración) |
