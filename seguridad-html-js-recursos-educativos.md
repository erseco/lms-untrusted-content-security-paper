...
| El modo seguro aísla (origen opaco) | Vivo en **prototipo** (modificación de código propuesta; Chromium y Firefox 146/Gecko) | [4.5](#sec-4-5)–[4.6](#sec-4-6); `resultados-firefox*.json` |
...
| `mod_exelearning`, `wp-exelearning`, `omeka-s-exelearning` | Autor/mantenedor | Objeto evaluado (estable) **y** mitigación propuesta (modo seguro, 6.2.2; propuesta de modificación de código) | `legacy`: vivo · `secure`: vivo en prototipo (Chromium + Firefox 146) |
